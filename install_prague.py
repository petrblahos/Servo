...
args['install_locale'] = raw_input('1/10 Locale [cs_CZ.UTF-8]: ') or 'cs_CZ.UTF-8'
...
args['timezone'] = raw_input('4/10 Timezone [Europe/Prague]: ') or 'Europe/Prague'
...
loc['city']     = raw_input('6/6 City [Prague]: ') or 'Prague'
